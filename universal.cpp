...
#define OFFSET_UWORLD 0x4A2FCE0
...
void update()
{
	...
	Gameinstance = ReadMemory<DWORD_PTR>(Uworld + 0x188);
	...
	CameraManager = ReadMemory<uint64_t>(PlayerController + 0x2c0);
...
Vector3 WorldToScreen(Vector3 WorldLocation)
{
	...
	auto CameraCache = ReadMemory<FCameraCacheEntry>(CameraManager + 0x1a60);
